...
public class RoleDaoImpl implements RoleDao {
	...
	public List<Role> findRoleByIds(Long[] ids) {
        final String sql = "select id, role, description, resource_ids as resourceIdsStr, available from sys_role where id in (?)";
        return jdbcTemplate.query(sql, new BeanPropertyRowMapper(Role.class),ids);
	}
